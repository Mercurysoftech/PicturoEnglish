...
//         return friend.friend_name.toLowerCase().contains(query);
//       }).toList();
//
//
...
//       ? friends.where((f) => f.friend_id != currentUserId).toList()
//       : filteredFriends.where((f) => f.friend_id != currentUserId).toList();
//

...
class EditProfile extends StatefulWidget {
  ...
  const EditProfile(
      {super.key, this.profileId, this.userName, this.email, this.mobile});
...
class _EditProfileState extends State<EditProfile> {
  ...
  void initState() {
    ...
    _mobileController =
        TextEditingController(text: widget.mobile.toString() ?? '');

    print(
        'name: ${widget.userName} and Email: ${widget.email} and Mobile: ${widget.mobile} and ProfileId: ${widget.profileId}');
  ...
  Future<void> _loadAvatar() async {
    ...
    try {
      ...
      avatarResponse.data
          .forEach((a) => print('Avatar ID: ${a.id}, URL: ${a.avatarUrl}'));
      ...
      print(
          'Found matching avatar: ${avatar.id} - ${baseUrl + avatar.avatarUrl}');
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      ).then((returnedValue) async {
                        // Changed this to handle the returned avatar ID
                  ...
                  decoration: InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(
                          color: Color(
                              0xFFDDDDDD)), // Blue Border when not focused
                    ),

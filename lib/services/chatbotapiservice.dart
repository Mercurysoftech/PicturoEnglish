...
class ChatBotApiService {
  ...
  static Future<ChatBotApiService> create() async {
    ...
    final dio = Dio(
      BaseOptions(
        baseUrl: "http://46.202.167.55:2030/",
    ...
    try {
      ...
      if (response.statusCode != 200) {
        if (response.statusCode == 403 &&
            ...
            dataMap['error'] != null) {
          // Allow it to fall through to parse the 403 backend error locally
        } else {
          throw DioException(
      ...
      // Handle error response (even with 200 or 403 status)
      if (dataMap is Map<String, dynamic> &&
          dataMap['error'] != null &&
          dataMap['error'].toString().isNotEmpty) {
